...
function ChatInput({ newMessage, isLoading, setNewMessage, submitNewMessage }) {
  ...
  return(
    <div className='mx-6 my-3 p-1.5 bg-primary-blue/[.30] rounded-3xl z-50 font-mono origin-bottom animate-chat duration-400'>
      <div className='pr-0.5 bg-white relative shrink-0 rounded-3xl overflow-hidden ring-primary-blue ring-1 focus-within:ring-2 transition-all'>
        ...
        />
        <button
          className='absolute top-1/2 -translate-y-1/2 right-3 p-1 rounded-md hover:bg-secondary-blue/50'
