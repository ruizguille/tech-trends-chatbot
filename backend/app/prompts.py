...
Make sure to reference and quote fragments from the context that support your answer. You are a reliable assistant and your answers must always be based on truth.
